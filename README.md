...
## 概要
エフェクトブラウザでエフェクト一覧が表示され、任意のエフェクトをクリックすることで選択中のアイテムに適用できます。
映像エフェクト／音声エフェクト以外にもお気に入り、履歴、選択中のアイテムのエフェクト編集などが可能です。
...
## コードについて
- このプラグインはClaude、Gemini(Antigravity)、GitHub Copilotを用いて制作しています。そのためコード内に複数のコメントがあると思われます。予めご了承ください。
...
## changelog
2026/09/01 v1.0.0 公開
2026/09/02 v1.1.0 多言語化（英語、中国語繁体、中国語簡体に対応。）、プリセット機能の廃止、フォルダの操作感の向上および機能の向上
